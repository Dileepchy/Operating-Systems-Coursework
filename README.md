...
This journal documents the development, security hardening, and performance analysis of a headless Linux server. The goal is to build a sustainable, secure, and efficient server environment as part of the CMPN202 coursework.
